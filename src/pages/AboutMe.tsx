	...
	const items = [
		{
			...
			className:
				"absolute top-6 left-[5%] rotate-[-5deg] xs:top-8 xs:left-[6%] sm:top-12 sm:left-[8%] md:top-16 md:left-[8%] lg:top-20 lg:left-[10%] xl:top-30 xl:left-[10%]",
		},
		{
			title: "Supertree Grove",
			image: "/src/assets/images/aboutme/gbtb.svg",
			className:
				"absolute top-20 left-[8%] rotate-[-7deg] xs:top-24 xs:left-[10%] sm:top-32 sm:left-[10%] md:top-36 md:left-[12%] lg:top-44 lg:left-[10%] xl:top-60 xl:left-[10%]",
		},
		{
			title: "Subway",
			image: "/src/assets/images/aboutme/subway.svg",
			className:
				"absolute top-4 left-[30%] rotate-[8deg] xs:top-6 xs:left-[32%] sm:top-8 sm:left-[35%] md:top-12 md:left-[38%] lg:top-16 lg:left-[42%] xl:top-25 xl:left-[45%]",
		},
		{
			title: "Universal Exp",
			image: "/src/assets/images/aboutme/car.svg",
			className:
				"absolute top-16 left-[40%] rotate-[10deg] xs:top-20 xs:left-[42%] sm:top-28 sm:left-[45%] md:top-32 md:left-[48%] lg:top-36 lg:left-[52%] xl:top-60 xl:left-[55%]",
		},
		{
			title: "Glass House",
			image: "/src/assets/images/aboutme/me 3.svg",
			className:
				"absolute top-12 right-[30%] rotate-[2deg] xs:top-16 xs:right-[32%] sm:top-24 sm:right-[35%] md:top-28 md:right-[38%] lg:top-32 lg:right-[42%] xl:top-50 xl:right-[45%]",
		},
		{
			title: "Seattle :)",
			image: "/src/assets/images/aboutme/me 2.svg",
			className:
				"absolute top-8 left-[35%] rotate-[-7deg] xs:top-12 xs:left-[37%] sm:top-16 sm:left-[40%] md:top-20 md:left-[43%] lg:top-24 lg:left-[47%] xl:top-40 xl:left-[50%]",
		},
		{
			title: "Singapore '25",
			image: "/src/assets/images/aboutme/me.svg",
			className:
				"absolute top-10 left-[15%] rotate-[4deg] xs:top-14 xs:left-[17%] sm:top-20 sm:left-[20%] md:top-24 md:left-[23%] lg:top-28 lg:left-[28%] xl:top-45 xl:left-[30%]",
		},
	];
		...
		<div className="text-white w-full">
			...
			<div className="block xl:hidden min-h-screen">
				...
				<div className="p-3 xs:p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[40vh] sm:min-h-[45vh] lg:min-h-[50vh]">
					<p className="special-gothic mb-3 xs:mb-4 sm:mb-4 md:mb-5 lg:mb-6 mt-4 xs:mt-6 sm:mt-8 md:mt-12 lg:mt-16 text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center text-[#f7e6c8]">
						About Me
					</p>
					<p className="special-gothic mx-10 mb-4 xs:mb-5 sm:mb-6 md:mb-8 lg:mb-10 text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl text-center text-[#655b4b] px-1 xs:px-2 sm:px-3 md:px-4 leading-relaxed">
			...
			<div className="hidden xl:flex min-h-screen">
				...
				<div className="w-1/2 p-8 xl:p-10 2xl:p-12 flex flex-col justify-center">
					<p className="special-gothic mb-4 xl:mb-6 2xl:mb-8 mt-32 xl:mt-40 2xl:mt-52 text-3xl xl:text-4xl 2xl:text-5xl text-center text-[#f7e6c8]">
						About Me
					</p>
					<p className="special-gothic mb-8 xl:mb-10 2xl:mb-12 text-base xl:text-2xl 2xl:text-2xl text-center text-[#655b4b] leading-relaxed xl:leading-relaxed 2xl:leading-loose">
						I am a dedicated web and mobile app developer with a strong passion
						for mastering programming languages such as React, Vite, Vue,
						NextJS, Expo, Flutter and React Native. I use my expertise in
						website and mobile application design to contribute practical ideas,
