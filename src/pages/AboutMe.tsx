		...
		<div className="text-white w-full">
			...
			<div className="block xl:hidden min-h-screen">
				...
				<div className="p-3 xs:p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center min-h-[40vh] sm:min-h-[45vh] lg:min-h-[50vh]">
					<p className="main-font mb-3 xs:mb-4 sm:mb-4 md:mb-5 lg:mb-6 mt-4 xs:mt-6 sm:mt-8 md:mt-12 lg:mt-16 text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl text-center text-[#f7e6c8]">
						About Me
					</p>
					<p className="main-font mb-4 xs:mb-5 sm:mb-6 md:mb-8 lg:mb-10 text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl text-center text-[#f7e6c8] px-1 xs:px-2 sm:px-3 md:px-4 leading-relaxed">
			...
			<div className="hidden xl:flex min-h-screen">
				...
				<div className="w-1/2 p-8 xl:p-10 2xl:p-12 flex flex-col justify-center">
					<p className="main-font mb-4 xl:mb-6 2xl:mb-8 mt-32 xl:mt-40 2xl:mt-52 text-xl xl:text-2xl 2xl:text-3xl text-center text-[#f7e6c8]">
						About Me
					</p>
					<p className="main-font mb-8 xl:mb-10 2xl:mb-12 text-lg xl:text-xl 2xl:text-2xl text-center text-[#f7e6c8] leading-relaxed xl:leading-relaxed 2xl:leading-loose">
						I am a dedicated web and mobile app developer with a strong passion
						for mastering programming languages such as React, Vite, Vue,
						NextJS, Expo, Flutter and React Native. I use my expertise in
						website and mobile application design to contribute practical ideas,
