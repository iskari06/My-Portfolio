				...
				{data.map((item, index) => (
					...
					>
						<div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
							...
							<h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-[#655b4b] dark:text-[#655b4b] ">
								{item.title}
							</h3>
						</div>

						<div className="relative text-base pl-20 pr-4 md:pl-4 w-full">
							<h3 className="md:hidden block text-3xl mb-4 text-left font-bold text-[#655b4b] dark:text-[#655b4b]">
								{item.title}
							</h3>
							{item.content}{" "}
						</div>
